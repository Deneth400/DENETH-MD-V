...
try {
           ...
           await conn.sendMessage(from, { audio:{ url: prog.result.download_url }, mimetype: 'audio/mpeg', caption: foot}, { quoted: mek })
         } catch (e) {
	       console.log(e)
        }
    })
...
try {
           ...
           await conn.sendMessage(from, { document:{ url: prog.result.download_url }, mimetype: 'audio/mpeg' , fileName: title + '.mp3',cpation: foot}, { quoted: mek });
         } catch (e) {
	       console.log(e)
        }
    })
